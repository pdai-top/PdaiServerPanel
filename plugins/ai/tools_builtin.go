...
func registerMemoryTools(r *ToolRegistry) {
	...
	r.Register(&Tool{
		...
		Description: "Get iptables firewall status including whether it is installed, available, version, and the virtual iptables backend used by the panel.",
		Parameters: jsonSchema(map[string]interface{}{
			"type":       "object",
			"properties": map[string]interface{}{},
		}),
	...
	r.Register(&Tool{
		...
		Description: "List iptables firewall rules managed by the panel. The optional zone parameter is kept for compatibility and only accepts 'iptables'.",
		Parameters: jsonSchema(map[string]interface{}{
			"type": "object",
			"properties": map[string]interface{}{
				"zone": map[string]interface{}{
					"type":        "string",
					"description": "Compatibility field; leave empty or use 'iptables'",
				},
			},
		}),
		ReadOnly: true,
	...
	r.Register(&Tool{
		...
		Description: "Add or remove an iptables firewall rule. Supports port rules (e.g. 8080/tcp) and built-in service shortcuts (ssh, http, https). Note: Docker containers using -p port mapping can bypass panel-managed iptables rules unless Docker networking is configured accordingly.",
		Parameters: jsonSchema(map[string]interface{}{
			"type": "object",
			"properties": map[string]interface{}{
				"action": map[string]interface{}{
				...
				"type": map[string]interface{}{
					...
					"description": "Type of rule: 'port' for port/protocol rules, 'service' for built-in shortcuts such as ssh, http, or https",
				},
				"zone": map[string]interface{}{
					"type":        "string",
					"description": "Compatibility field; leave empty or use 'iptables'",
