...
// HostDomain represents an additional domain bound to a host.
...
type Host struct {
	...
	HTTPRedirect   *bool  `gorm:"default:false" json:"http_redirect"`
	...
	CustomDirectives string `gorm:"type:text" json:"custom_directives"`    // legacy Caddy directives fragment
	FullCaddyBlock   string `gorm:"type:text" json:"full_caddy_block"`     // full per-site Caddy block override
	...
	Domains         []HostDomain   `gorm:"foreignKey:HostID;constraint:OnDelete:CASCADE" json:"domains"`
...
type HostCreateRequest struct {
	...
	FullCaddyBlock   string           `json:"full_caddy_block"`
