...
import (
	...
	"github.com/pdai/pdai/internal/versions"
)
...
func (m *Manager) Start() error {
	...
	if _, err := os.Stat(m.cfg.CaddyfilePath); os.IsNotExist(err) {
		...
		os.MkdirAll(filepath.Dir(m.cfg.CaddyfilePath), 0755)
		defaultCfg := fmt.Sprintf("# Auto-generated by Pdai\n{\n\tadmin localhost:2019\n\tlog {\n\t\toutput file %s/caddy.log {\n\t\t\troll_size 100MiB\n\t\t\troll_keep 5\n\t\t}\n\t\tlevel INFO\n\t}\n}\n", m.cfg.LogDir)
...
const remoteVersionsURL = "https://raw.githubusercontent.com/pdai/pdai/refs/heads/main/VERSIONS"
