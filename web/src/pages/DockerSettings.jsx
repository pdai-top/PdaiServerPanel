...
export default function DockerSettings() {
    ...
    const [runtime, setRuntime] = useState(runtimeParam)
        ...
        <Box>
            ...
            {isPodman && (
                <Callout.Root color="blue" mb="4">
                    <Callout.Icon><Settings size={16} /></Callout.Icon>
                    <Box>
                        <Text size="2" weight="bold" style={{ display: 'block' }}>
                            {t('docker.podman_config_title')}
                        </Text>
                        <Text size="2" style={{ display: 'block' }}>
                            {t('docker.podman_config_desc')}
                        </Text>
                    </Box>
                </Callout.Root>
            )}
                ...
                <Flex justify="end">
                    <Button size="3" disabled={saving} onClick={handleSave}>
                        {saving ? (
                            ...
                            <><RefreshCw size={16} /> {isPodman ? t('docker.save_config') : t('docker.save_restart')}</>
                        )}
                    </Button>
                </Flex>
                </fieldset>
